    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button
            variant={'ghost'}
            className='hover:bg-destructive/20 hover:text-red-500 hover:animate-shake'
          >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className=' space-y-1'>
              <FormLabel>
                Ingrese <span className=' font-bold'>{nameCommand}</span> para
                confirmar
              </FormLabel>
              <FormControl>
                <Input
                  type='text'
                  className='border-destructive focus-visible:ring-destructive focus-visible:border-none'
                  placeholder={nameCommand}
                  {...field}
                />
              </FormControl>
              <FormMessage />
