...
import InfinityLogo from '@/components/logo-infinity'


export default function LoginAuth () {
  return (
    <main className='relative h-screen flex-col items-center justify-center grid grid-cols-1 lg:max-w-none lg:grid-cols-2 lg:px-0 '>
      <section className=' container h-screen flex justify-center items-center w-full mx-auto  relative overflow-hidden'>
        ...
        <InfinityLogo className=' absolute top-5 lg:top-10 left-1/2 -translate-x-1/2  size-[80px]' />
    ...
    <SectionCarousel content={CAROUSEL_LOGIN}/>
    </main>
  )
}
