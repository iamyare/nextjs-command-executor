...
export async function createAuthCode({ clientId, redirectUri, state }: { clientId: string, redirectUri: string, state: string, scope: string | null }) {
...
export async function UpdateCommand({ data }: { data: CommandUpdate }) {
