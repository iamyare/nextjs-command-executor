...
<Button variant="ghost"  size="icon"  >
  <motion.div
    animate={theme === 'system' ? (isSystemDark ? "hidden" : "visible") : (theme === 'dark' ? "hidden" : "visible")}
    variants={sunVariants}
    className={theme === 'system' ? (isSystemDark ? 'hidden' : 'block') : (theme === 'dark' ? 'hidden' : 'block')}
  >
    <Sun className="size-5" />
  </motion.div>
  <motion.div
    animate={theme === 'system' ? (isSystemDark ? "visible" : "hidden") : (theme === 'dark' ? "visible" : "hidden")}
    variants={moonVariants}
    className={theme === 'system' ? (isSystemDark ? 'block' : 'hidden') : (theme === 'dark' ? 'block' : 'hidden')}
  >
